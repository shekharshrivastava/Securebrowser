...
public class BrowserSettings implements OnSharedPreferenceChangeListener,PreferenceKeys {
    ...
    private static final String HONEYCOMB_USERAGENT = "Mozilla/5.0 (Linux; U; " +
            "Android 4.1; en-us; Xoom Build/HMJ25) AppleWebKit/534.13 " +
    ...
    private Runnable mSetup = new Runnable() {
        ...
        public void run() {
            ...
            if (((ActivityManager) mContext.getSystemService(Context.ACTIVITY_SERVICE)).getMemoryClass() > 16) {
...
//        settings.setNavDump(enableNavDump());
    ...
    public void onSharedPreferenceChanged(
        ...
        syncManagedSettings();
        if (PREF_LINK_PREFETCH.equals(key)) {
    ...
    public void clearFormData(WebView webView) {
    ...
    public void toggleMobileUseragent(WebView view) {
        if (view == null) {
            return;
        }
        WebSettings settings = view.getSettings();
        if (mCustomUserAgents.get(settings) != null) {
            ...
            mCustomUserAgents.put(settings, HONEYCOMB_USERAGENT);
            settings.setUserAgentString(HONEYCOMB_USERAGENT);
        }
    }
...
//        }
    ...
    public String getHomePage() {
        return mPrefs.getString(PREF_HOMEPAGE, "http://google.com");
    }
