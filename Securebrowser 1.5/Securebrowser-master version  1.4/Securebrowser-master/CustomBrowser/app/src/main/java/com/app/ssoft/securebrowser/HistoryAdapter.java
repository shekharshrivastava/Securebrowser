...
public class HistoryAdapter extends ArrayAdapter<History> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView faviconsIV = (ImageView) layout.findViewById(R.id.faviconsIV);
        ...
        if (h.favicon != null) {
            faviconsIV.setImageBitmap(Utils.StringToBitMap(h.favicon));
        } else {
            faviconsIV.setImageDrawable(context.getResources().getDrawable(R.drawable.history));
        }
